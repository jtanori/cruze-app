...
## Responsibility
ACCESO progressive disclosure

## Details
Auto/A pie etc. user-profile contextual.
...
## Status
- Spec: defined
- Implementation: `src/components/crossing/CrossingDetailAccessSection.tsx` — eyebrow via t("crossings.expanded.access") (reused); values are caller data passthrough. Fully i18n.
...
## File Reference
- Spec doc: `design/components/CR-DET-04-CrossingDetailAccessSection.md` (this file)
