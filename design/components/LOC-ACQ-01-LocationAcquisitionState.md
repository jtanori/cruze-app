...
## Responsibility
L02 acquisition loading state

## Details
Pulsing MapPin + three-dots + Obteniendo tu ubicación…
...
## File Reference
- Spec doc: `design/components/LOC-ACQ-01-LocationAcquisitionState.md` (this file)
