...
**Version:** 1.0 — 2026-09-16 — new; post-crossing confirm modal from detection store. If mismatch with `apps/web/src/app/globals.css:94`, revisit.
