...
## Responsibility
RESTRICCIONES expandable

## Details
Data-driven never invents legal requirements.
...
## Status
- Spec: defined
- Implementation: `src/components/crossing/CrossingDetailRestrictionsSection.tsx` — eyebrow t("crossings.expanded.restrictions"), empty t("crossings.expanded.restrictionsEmpty"); items are caller data. Fully i18n.
...
## File Reference
- Spec doc: `design/components/CR-DET-07-CrossingDetailRestrictionsSection.md` (this file)
