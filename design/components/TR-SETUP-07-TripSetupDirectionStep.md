...
- Implementation:
  - `src/components/trip/TripSetupDirectionStep.tsx` — presentational radio-card selector; props `value`/`onSelect`; fully i18n via labelKey/subKey; selection styling only, routing owned by Flow
