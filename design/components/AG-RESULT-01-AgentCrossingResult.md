...
## Responsibility
Structured crossing card

## Details
San Luis wait total [Ver cruce][Navegar] deep-links to detail.
...
## Status
- Spec: defined
- Implementation: see `src/components/` (domain: ag)
...
- Implementation: `src/components/ag/` or domain folder
