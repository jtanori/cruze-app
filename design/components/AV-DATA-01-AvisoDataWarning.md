> RETIRED — superseded by AV-DET-01. No per-type implementation exists; the single generic `src/components/avisos/AvisoDetail.tsx` serves ALL `AvisoType` values (`apps/web/src/lib/avisos.ts:9-18`). This doc is retained for catalog history only — do not implement against it. Data-warning renders through AV-DET-01; no `AvisoDataWarning.tsx` exists.
...
## Responsibility
Data warning stale/unavailable
...
## File Reference
- Spec doc: `design/components/AV-DATA-01-AvisoDataWarning.md` (this file)
