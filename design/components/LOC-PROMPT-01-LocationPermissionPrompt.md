...
## Responsibility
L01 permission explanation and CTA

## Details
¿Dónde estás? + Permitir ubicación + Buscar ubicación + Configuración.
...
## File Reference
- Spec doc: `design/components/LOC-PROMPT-01-LocationPermissionPrompt.md` (this file)
