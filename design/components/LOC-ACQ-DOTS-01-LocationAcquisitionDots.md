# LOC-ACQ-DOTS-01 — LocationAcquisitionDots
...
## Name
LocationAcquisitionDots

## Responsibility
Inline three-dots loading animation

## Details
Cruze Mint bouncing dots, used in L02 and L01→L02 transition.
...
## File Reference
- Spec doc: `design/components/LOC-ACQ-DOTS-01-LocationAcquisitionDots.md` (this file)
