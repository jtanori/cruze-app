...
export default function SettingsPage() {
  ...
  return <div className="px-4 sm:px-5 py-4 sm:py-6 max-w-sm sm:max-w-lg mx-auto"><SettingsRoot onProfile={() => router.push(`/${locale}/settings/profile`)} onFavorites={() => router.push(`/${locale}/settings/favorites`)} onMyTrips={() => router.push(`/${locale}/settings/trips`)} onDataSharing={() => router.push(`/${locale}/settings/data-sharing`)} onAbout={() => router.push(`/${locale}/settings/about`)} /></div>;
}
