      ...
      {mode === "choose" && !selected && (
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={gpsLoading}
            className="w-full flex items-center gap-4 sm:gap-6 bg-surface border border-border rounded-[var(--radius-md)] px-4 py-4 active:bg-surface-elevated transition-colors"
          >
