...
export function TripSetupFlow() {
  ...
  return (
    <div className="min-h-dvh bg-background flex flex-col">
      ...
      <div className="flex-1 px-4 sm:px-5 py-4 sm:py-6 max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto w-full">
        {step === "destination" && (
      ...
      {step !== "destination" && step !== "documentProfile" && (
        <div className="px-5 pb-6 max-w-sm sm:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto w-full">
          <button
            onClick={goBack}
